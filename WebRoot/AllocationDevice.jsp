				...
				<form id="formSearch" class="form-horizontal">
					<div class="form-group" style="margin-top:15px">
						<label class="control-label col-sm-1"
							for="txt_search_departmentname">设备号</label>
						<div class="col-sm-3">
							<input type="text" class="form-control"
								id="txt_search_departmentname">
						</div>
						<label class="control-label col-sm-1" for="txt_search_statu">分配用户名</label>
						<div class="col-sm-3">
				...
				<div class="modal-body">
					<form id="add_form_modal" class="form-horizontal">
						...
						<div class="form-group" id="for_hide">
							<div class="col-sm-3">
								<label class="control-label" for="add_owner">分配用户</label>
							</div>
						...
						<div class="form-group">
							<div class="col-sm-3">
								<label class="control-label" for="add_adate">日期</label>
							</div>

							<div class="col-sm-9">
								<input type="text" name="adate"
									class="form-control" id="add_adate"/>
							</div>
						</div>
...
var TableInit= function(){
    ...
    oTableInit.Init = function () {
    	$('#tb_departments').bootstrapTable({
          url: 'Device?method=list',   //url一般是请求后台的url地址,调用ajax获取数据。此处我用本地的json数据来填充表格。
    ...
    oTableInit.queryParams = function (params) {
        ...
        var temp = {   //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
            ...
            device: $("#txt_search_departmentname").val(),
            user: $("#txt_search_statu").val(),
        };
        return temp;
    };
    return oTableInit;
