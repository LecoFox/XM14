		...
		<div class="header-info-right">
			<div class="header cbp-spmenu-push">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left"
					id="cbp-spmenu-s1"> <a href="showall.jsp">用户注册信息</a> <a
					href="loginstatus.jsp">用户在线信息</a> <a href="allocation_device.jsp">设备分配</a>
				<a href="overspeed.jsp">超速统计</a> <a
					href="javascript:openWin('gettrack.jsp')">轨迹回放</a> <a
					href="mileage.jsp">里程统计</a> </nav>
				<!--script-nav -->
				<script>
					$("span.menu").click(function() {
